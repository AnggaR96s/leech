...
?>
  ...
  <tr>
    <td align="right">Columns : </td><td><select name=cs><option value= > 1 </option>
                                                         ...
                                                         <option value=5 selected> 5 </option></select> x <select name=rs><option value= > 1 </option>
                                                                                                                <option value=2> 2 </option>
                                                                                                                <option value=3> 3 </option>
                                                                                                                <option value=4> 4 </option>
  ...
  <tr>
    <td align="right">Text <span class="nav_text" onMouseOver="document.getElementById('help_text4').style.display='block'" onMouseOut="document.getElementById('help_text4').style.display='none'" style="cursor:help"> [?]</span> : </td><td><input type=text name=T size=15 value='- RAPIDLEECH -'></td>
  </tr>
  <tr>
